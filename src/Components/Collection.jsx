  ...
  Object.entries(collections).map(([key, value]) => {
    return (
      <>
        ...
        <div className="image">
          <img className="generatedImage" onClick={()=>{
            console.log("Asdasd",key);
            navigate("/collectionslist",{ state:{"value":value ,"key":key} })
          }} src={`http://20.55.71.246:3000/${value[0].url}`} />
          {/* <img onClick={() => downloadImage(data.data.url)} className="downloadIcon" src="assets/images/download-icon.svg" /> */}
        ...
        <h3 style={{marginTop:5}}>{key.toUpperCase()}</h3>
      </div>
